...
The official server for the [Super Mario Odyssey: Online +](https://github.com/DaDev123/SMOO-Plus) mod.

## Windows Setup

1. Download latest build from [Releases](https://github.com/KleinTimmi/Smoo-Plus-Server/releases)
2. Run `Server.exe`
3. `settings.json` is autogenerated in step 2, modify it however you'd like.

## Building (Mac/Linux Setup)

Must have the [.NET 8 SDK](https://dotnet.microsoft.com/en-us/download) and Git installed.
...
```shell
docker  run  --rm  -it  -p 1027:1027  -v "/$PWD/data/://data/"  ghcr.io/KleinTimmi/Smoo-Plus-Server
